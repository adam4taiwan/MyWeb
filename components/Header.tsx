      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/blog" className="text-gray-700 hover:text-amber-600 transition-colors cursor-pointer">命理文章</Link>
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 pb-4 border-t border-amber-200">
            <nav className="flex flex-col space-y-4 mt-4">
              ...
              <Link href="/blog" className="text-gray-700 hover:text-amber-600 transition-colors cursor-pointer" onClick={() => setIsMenuOpen(false)}>命理文章</Link>
